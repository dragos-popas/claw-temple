#!/usr/bin/env node
// ============================================================================
// CLAW-TEMPLE - Database Initialization (Clean Start)
// ============================================================================
...
async function main() {
  ...
  // Agent pools table (NO DEFAULT POOLS - user creates their own)
  db.exec(`
  ...
  // Seed default templates ONLY (no default pools)
  ...
  console.log('⚠️  No default pools - create your own!\n');
}
